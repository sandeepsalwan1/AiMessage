...
AiMessage is a full-stack messaging application that combines real-time communication with mental health awareness features. Built with modern web technologies, it demonstrates expertise in database design, real-time data management, and scalable architecture. Used tools like react, Next.js, Prisma (with MySQL (Aiven)), Tailwind CSS, Javascript, Pusher, Github+Google OAUTH, and TypeScript for the complete deployment of this application.
